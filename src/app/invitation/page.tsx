...
export default function InvitationPage() {
  const verses = [
    ...
    {
      ref: "2 Corinthians 5:17–20 (The Message)",
      text:
  ...
  return (
    <article className="mt-4">
      ...
      <ul className="ml-5 list-disc space-y-3 font-b text-[12pt] leading-[1.65] text-ink">
        <li>The Good News isn’t just about going to heaven—it’s about entering life under God’s reign now.</li>
        <li>We enter His Kingdom not by earning, but by trusting and surrendering to King Jesus.</li>
        <li>Surrendering to Jesus means becoming His disciple—learning His ways, growing in His character, walking in His power.</li>
        <li>The King’s story of renewal is still unfolding—and He’s inviting you to join.</li>
      </ul>
