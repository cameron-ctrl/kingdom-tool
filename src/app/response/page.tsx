    ...
    <article className="mx-auto mt-8 max-w-3xl space-y-8 font-b text-[12pt] leading-[1.65] text-ink">
      ...
      <ul className="list-disc space-y-5 pl-5">
        <li>
          ...
          Kingdom.
          <div className="mt-2 rounded-md border border-ink/10 bg-offWhite p-3 text-[11.5pt] leading-[1.6]">
            <em>Acts 2:38 (NIV)</em>: “Peter replied, ‘Repent and be baptized,
        ...
        <li>
          ...
          <div className="mt-2 rounded-md border border-ink/10 bg-offWhite p-3 text-[11.5pt] leading-[1.6]">
            <em>Acts 2:42 (NIV)</em>: “They devoted themselves to the apostles’
        ...
        <li>
          ...
          <div className="mt-2 rounded-md border border-ink/10 bg-offWhite p-3 text-[11.5pt] leading-[1.6]">
            <em>John 14:23 (NIV)</em>: “Jesus replied, ‘Anyone who loves me will
        ...
        <li>
          ...
          <div className="mt-2 rounded-md border border-ink/10 bg-offWhite p-3 text-[11.5pt] leading-[1.6]">
            <em>Matthew 28:19–20 (NIV)</em>: “Therefore go and make disciples of
